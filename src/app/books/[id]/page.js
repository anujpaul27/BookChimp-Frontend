...
const book = {
  ...
  author: "Harper Lee",
  description: "Look for The Land of Sweet Forever, a posthumous collection of newly discovered stories and essays. Harper Lee's only novel, published in 1960, became an instant classic and won the Pulitzer Prize. The story is told through the eyes of young Scout Finch as she navigates racial injustice and moral growth in the American South.",
  price: 13.20,
  category: "Fiction", // Changed to Fiction (classic novel)
  ...
  return (
    <div className="min-h-screen bg-base-100 py-10">
      <div className="max-w-6xl mx-auto px-6">
        {/* Back Button */}
        <Link href="/browse" className="inline-flex items-center gap-2 text-base-content/70 hover:text-base-content mb-8">
          <ArrowLeft size={20} />
          Back to Browse
        </Link>
