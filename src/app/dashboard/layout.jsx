...
const user =  [
    ...
    { label: "Pending Deliveries", href: "/dashboard/user/delivery-history", icon: Package },
    { label: "Reading List", href: "/dashboard/user/my-reading-list", icon: BookOpen },
    { label: "My Reviews", href: "/dashboard/user/my-reviews", icon: Star },
  ]

const librarian = [
    { label: "Overview", href: "/dashboard/librarian", icon: LayoutDashboard },
    { label: "Add Book", href: "/dashboard/librarian-add", icon: BookOpen },
    { label: "Manage Inventory", href: "/dashboard/librarian-inventory", icon: Package },
    { label: "Manage Deliveries", href: "/dashboard/librarian-deliveries", icon: ClipboardList },
  ]

const admin = [
    { label: "Overview", href: "/dashboard/admin", icon: LayoutDashboard },
    { label: "Approval Queue", href: "/dashboard/admin-queue", icon: ShieldCheck },
  ...
  return (
    <div className="min-h-screen bg-base-200 flex">
      ...
      <div className={`${sidebarOpen ? "w-72" : "w-20"} bg-base-100 border-r border-base-300 transition-all duration-300`}>
        ...
        <nav className="p-4">
          {}
          { (isPending) ? <div className="mx-auto my-auto ">Loading...</div> :  navItems.map((item) => {
